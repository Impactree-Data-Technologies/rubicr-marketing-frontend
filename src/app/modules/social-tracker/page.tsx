...
const TaskManagement = () => {
  ...
  const features = [
    {
      ...
      description: "A robust framework to measure and evaluate social impact.",
      details: [
    ...
    },
    {
      ...
      description: "Timely access to key performance indicators and progress updates",
      details: [
    ...
    },
    {
      ...
      description: "Tailored recommendations based on specific organizational goals and beneficiary needs",
      details: [
  ...
  const overviewHighlights = [
    ...
    {
      icon: HiGlobeAlt,
      title: "Sentiment and Trend Analysis",
  ...
  const benefits = [
    { 
      ...
      title: "By focusing on high-impact initiatives, organizations can maximize their positive influence",
      // description: "Empowers sustainability managers by distributing data collection tasks across teams efficiently"
    },
    { 
      icon: HiCheckCircle, 
      title: "Streamlined data collection and analysis processes",
    ...
    { 
      icon: HiTrendingUp, 
      title: " Improved communication and engagement with beneficiaries and the public",
  ...
  return (
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 md:space-y-6 mt-8">
            ...
            >
            Monitor and enhance your company’s social impact and initiatives
            </motion.p>
          ...
          <div className="order-1 lg:order-2 flex justify-center items-center">
            ...
            >
             <Image
          src="/Social Tracker.jpg"  // Replace with your actual image path
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        > */}
          <Image 
            src="/social-tracker.png"  // Use the same image for all features
