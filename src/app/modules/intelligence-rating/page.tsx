...
const TaskManagement = () => {
  ...
  const features = [
    {
      ...
      title: "Comprehensive ESG Assessment for a 360° view.",
    ...
    },
    {
      ...
      title: "Risk Identification to prioritize and address potential vulnerabilities.",
    ...
    },
    {
      ...
      title: "Streamlined ESG Reporting for efficient communication.",
  ...
  const overviewHighlights = [
    {
      icon: HiShieldCheck,
      title: "Integrate and clean data from diverse organizational sources for high accuracy.",
    //   description: "Ensure regulatory adherence with comprehensive tracking and documentation."
    },
    {
      icon: HiDocumentText,
      title: "Analyze data against 15 key ESG indicators to highlight risks and opportunities.",
    //   description: "Generate sophisticated, customizable reports with advanced analytics."
    },
    {
      icon: HiGlobeAlt,
      title: "Develop actionable improvement plans with clear recommendations.",
  ...
  const benefits = [
    { 
      ...
      description: "Avoid costly penalties with proactive mitigation."
    },
    { 
      icon: HiCheckCircle, 
      title: "Increased Stakeholder Value",
      description: "Build trust with investors, customers, and employees."
    },
    { 
      icon: HiTrendingUp, 
      title: "Regulatory Compliance",
      description: " Ensure adherence to evolving ESG standards."
    }
  ];
  ...
  return (
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 md:space-y-6 mt-8">
            ...
            >
            A comprehensive scoring system that evaluates an organizations environmental performance, resource efficiency, and long-term ecological impact across multiple dimensions
            </motion.p>
          ...
          <div className="order-1 lg:order-2 flex justify-center items-center">
            ...
            ><Image
            src="/sustainable inteligence.jpg"  // Replace with your actual image path
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        > */}
          <Image 
            src="/sustainable-intelligence-rating.png"  // Use the same image for all features
