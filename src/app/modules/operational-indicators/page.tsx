...
const OperationalIndicators = () => {
  ...
  const features = [
    {
      ...
      title: "Real-Time KPI Tracking for proactive management.",
    //   description: "Real-Time KPI Tracking for proactive management.",
      details: [
    ...
    },
    {
      ...
      title: "Data Visualization to simplify decision-making.",
    //   description: "Data Visualization to simplify decision-making.",
      details: [
    ...
    },
    {
      ...
      title: "Trend Analysis to identify opportunities for sustainable growth.",
    //   description: "Trend Analysis to identify opportunities for sustainable growth.",
      details: [
  ...
  const overviewHighlights = [
    {
      icon: HiShieldCheck,
      title: "Collect and clean data on key KPIs like carbon emissions and waste reduction.",
    //   description: "Ensure regulatory adherence with comprehensive tracking and documentation."
    },
    {
      icon: HiDocumentText,
      title: "Track KPI progress over time with real-time insights.",
    //   description: "Generate sophisticated, customizable reports with advanced analytics."
    },
    {
      icon: HiGlobeAlt,
      title: "Visualize trends through customizable charts and benchmarking tools.",
  ...
  const benefits = [
    { 
      ...
      description: " Strategize effectively with reliable insights."
    },
    { 
      icon: HiCheckCircle, 
      title: "Operational Efficiency",
      description: "Improve processes and reduce costs."
    },
    { 
      icon: HiTrendingUp, 
      title: "Sustainability Focus",
      description: "Reduce environmental impact and enhance reputation."
    }
  ];
  ...
  return (
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        > */}
          <Image 
            src="/track-key-operational-indicators.png"  // Use the same image for all features
