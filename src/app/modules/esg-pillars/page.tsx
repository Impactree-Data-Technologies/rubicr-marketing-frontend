...
const EsgPillars = () => {
  ...
  const features = [
    {
      ...
      title: "Simplified ESG Framework for clarity and focus.",
    ...
    },
    {
      ...
      title: "Action Planning Tools to turn insights into results.",
    ...
    },
    {
      ...
      title: "Reporting Templates for impactful stakeholder communication.",
  ...
  const overviewHighlights = [
    {
      icon: HiShieldCheck,
      title: "Break down complex ESG concepts into manageable components",
    //   description: "Ensure regulatory adherence with comprehensive tracking and documentation."
    },
    {
      icon: HiDocumentText,
      title: "Track performance over time to pinpoint opportunities for improvement.",
    //   description: "Generate sophisticated, customizable reports with advanced analytics."
    },
    {
      icon: HiGlobeAlt,
      title: "Develop and implement action plans to meet your ESG objectives.",
  ...
  const benefits = [
    { 
      ...
      title: "Improved ESG Performance",
      description: "Address gaps effectively."
    },
    { 
      icon: HiCheckCircle, 
      title: "Reputation Growth",
      description: "Enhance trust with stakeholders."
    },
    { 
      icon: HiTrendingUp, 
      title: "Investor Confidence",
      description: "Attract sustainable investment."
    }
  ];
