...
const SupplyChain = () => {
  ...
  const features = [
    {
      ...
      title: "Centralized Vendor Database for consolidated information.",
    ...
    },
    {
      ...
      title: "Automated Data Collection for efficiency and accuracy.",
    ...
    },
    {
      ...
      title: "ESG Rating System to evaluate supplier sustainability.",
  ...
  const overviewHighlights = [
    {
      icon: HiShieldCheck,
      title: "Onboard and assess vendors using ESG-centric criteria.",
    //   description: "Ensure regulatory adherence with comprehensive tracking and documentation."
    },
    {
      icon: HiDocumentText,
      title: "Automate data collection from supplier portals and public databases.",
    //   description: "Generate sophisticated, customizable reports with advanced analytics."
    },
    {
      icon: HiGlobeAlt,
      title: "Identify and mitigate supply chain risks through actionable insights.",
  ...
  const benefits = [
    { 
      ...
      description: "Uncover and address potential supply chain risks."
    },
    { 
      icon: HiCheckCircle, 
      title: "Sustainability Excellence",
      description: "Promote ethical sourcing and reduce emissions."
    },
    { 
      icon: HiTrendingUp, 
      title: "Cost Optimization",
      description: "Streamline procurement for significant savings."
    }
  ];
  ...
  return (
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 md:space-y-6 mt-8">
            ...
            >
            Gain full visibility into your supply chain for a more sustainable future.
          ...
          <div className="order-1 lg:order-2 flex justify-center items-center">
            ...
            >
             <Image
          src="/supply chain tracking.jpg"  // Replace with your actual image path
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        > */}
          <Image 
            src="/supplychain-tracking.png"  // Use the same image for all features
