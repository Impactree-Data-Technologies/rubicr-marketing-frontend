...
const TaskManagement = () => {
  ...
  const features = [
    {
      ...
      description: "Monitor emissions across organizational and unit levels.",
      details: [
    ...
    },
    {
      ...
      description: "Gain clarity through user-friendly charts and graphs.",
      details: [
    ...
    },
    {
      ...
      description: "Develop and implement impactful decarbonization plans.",
      details: [
  ...
  const overviewHighlights = [
    {
      icon: HiShieldCheck,
      title: "Collect and clean data at every level for unmatched accuracy.",
      // description: "Ensure regulatory adherence with comprehensive tracking and documentation."
    },
    {
      icon: HiDocumentText,
      title: "Apply robust calculation methodologies to determine emissions at both organizational and unit levels.",
      // description: "Generate sophisticated, customizable reports with advanced analytics."
    },
    {
      icon: HiGlobeAlt,
      title: "Present results through clear, intuitive visualizations like charts and graphs.",
  ...
  const benefits = [
    { 
      ...
      title: "Achieve enhanced accuracy and comprehensive emissions tracking.",
      // description: "Empowers sustainability managers by distributing data collection tasks across teams efficiently"
    },
    { 
      icon: HiCheckCircle, 
      title: "Create targeted decarbonization strategies for maximum impact.",
    ...
    { 
      icon: HiTrendingUp, 
      title: "Identify opportunities for energy efficiency and cost savings.",
  ...
  return (
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 md:space-y-6 mt-8">
            ...
            >
            Unit-wise tracking is a method of monitoring and analyzing performance, resource allocation, or progress at the individual unit or component level within an organization or system
            </motion.p>
          ...
          <div className="order-1 lg:order-2 flex justify-center items-center">
            ...
            >
              <Image
          src="/unit wise tracking.jpg"  // Replace with your actual image path
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        > */}
          <Image 
            src="/unitwise-tracking.png"  // Use the same image for all features
