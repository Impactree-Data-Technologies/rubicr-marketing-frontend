    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="relative min-h-screen bg-yellow-50">
          ...
          <div className="h-full flex items-center pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div className="pr-4">
                  <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Resources Overview</h1>
                ...
                <div className="mt-8 lg:mt-0 h-64 md:h-80 lg:h-96 relative">
                  <Image
                    src="/blog.jpg"
        ...
        <div className="bg-white py-12 md:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Getting started with ESG</h2>
            <p className="text-base md:text-lg text-gray-700 mb-8">Explainer articles to support your ESG and sustainability knowledge journey.</p>
        ...
        <div className="bg-gray-100 py-12 md:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-8">Articles on ESG regulations and reporting frameworks</h2>
            ...
            <div className="mt-12 flex justify-center">
              <nav className="inline-flex rounded-md shadow">
                <button className="px-4 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors duration-150">
                  &lt;
                </button>
                <button className="px-4 py-2 border-t border-b border-gray-300 bg-white text-sm font-medium text-gray-700">
                  3 / 4
                </button>
                <button className="px-4 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors duration-150">
                  &gt;
                </button>
              </nav>
            </div>
        ...
        <section className="bg-[#f6e2cb] py-16 md:py-20 lg:py-24 mx-4 md:mx-8 lg:mx-20 rounded-3xl my-12 md:my-16 lg:my-20">
          <div className="max-w-screen-xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Get Started Today</h2>
            <hr className="border-t-2 border-[#64271F] w-1/4 mb-6" />
            <p className="text-lg md:text-xl lg:text-2xl mb-8">Ready to transform your ESG Performance?</p>
...
const ResourceCard: React.FC<ResourceCardProps> = ({ type, title, description, link, duration }) => {
  return (
    <div className="bg-gray-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      <Link href={link} className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium transition-colors duration-150">
