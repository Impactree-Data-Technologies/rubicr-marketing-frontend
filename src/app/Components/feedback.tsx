    ...
    <div className={poppins.className}>
      <div className="bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
        <div className="w-full sm:max-w-4xl">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-full sm:max-w-4xl mx-auto">
            <blockquote className="text-lg italic text-gray-700 mb-4 text-center min-h-[120px] flex items-center justify-center">
              {quote}
            </blockquote>
